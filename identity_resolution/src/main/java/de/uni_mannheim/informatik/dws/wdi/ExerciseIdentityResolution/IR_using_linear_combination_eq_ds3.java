...
import de.uni_mannheim.informatik.dws.wdi.ExerciseIdentityResolution.Comparators.EarthquakeTimeComparatorMinutesHours;
...
public class IR_using_linear_combination_eq_ds3 
{
	/*
	 * Logging Options:
    ...
    public static void main( String[] args ) throws Exception
    {
		...
		// add comparators
		matchingRule.addComparator(new EarthquakeGeoCoordinatesComparator(), 0.2);
		matchingRule.addComparator(new EarthquakeDateComparator(), 0.3);
		matchingRule.addComparator(new EarthquakeTimeComparatorDifference(), 0.2);
		matchingRule.addComparator(new EarthquakeMagnitudeComparatorRounded(), 0.2);
		matchingRule.addComparator(new EarthquakeCountryComparatorLowerCaseJaccard(), 0.1);
		//matchingRule.addComparator(new EarthquakeDepthComparator(), 0.15);
		//matchingRule.addComparator(new EarthquakeTimeComparatorMinutes(), 0.06);

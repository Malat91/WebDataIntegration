 ...
 * 
 */
public class DeathsFuserMedian_eq extends
		AttributeValueFuser<Double, Earthquake, Attribute> {//for some reason median can only use doubles

	public DeathsFuserMedian_eq() {

 ...
 * 
 */
public class CountryFuserLongestString_eq extends
		AttributeValueFuser<String, Earthquake, Attribute> {

	public CountryFuserLongestString_eq() {
		super(new LongestString<Earthquake, Attribute>());
	}
	...
	public void fuse(RecordGroup<Earthquake, Attribute> group, Earthquake fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setAttributeProvenance(Earthquake.COUNTRY,

...
/**
 * {@link AttributeValueFuser} for the titles of {@link Earthquake}s.
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 * 
 */
public class CountryFuserShortestString_eq extends
		AttributeValueFuser<String, Earthquake, Attribute> {

	public CountryFuserShortestString_eq() {
		super(new ShortestString<Earthquake, Attribute>());
	}

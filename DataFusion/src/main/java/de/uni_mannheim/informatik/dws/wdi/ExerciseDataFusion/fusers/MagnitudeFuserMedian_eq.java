...
/**
 * {@link AttributeValueFuser} for the director of {@link Earthquake}s.
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 * 
 */
public class MagnitudeFuserMedian_eq extends
		AttributeValueFuser<Double, Earthquake, Attribute> {

	public MagnitudeFuserMedian_eq() {
		super(new Median<Earthquake, Attribute>());
	}

	@Override
	public boolean hasValue(Earthquake record, Correspondence<Attribute, Matchable> correspondence) {
		return record.hasValue(Earthquake.MAGNITUDE);
	}

	@Override
	public Double getValue(Earthquake record, Correspondence<Attribute, Matchable> correspondence) {
		return record.getMagnitude();
	}
	...
	public void fuse(RecordGroup<Earthquake, Attribute> group, Earthquake fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setMagnitude(fused.getValue());
		fusedRecord.setAttributeProvenance(Earthquake.MAGNITUDE,

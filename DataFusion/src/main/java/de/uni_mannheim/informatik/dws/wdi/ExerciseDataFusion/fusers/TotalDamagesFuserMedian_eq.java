 ...
 * 
 */
public class TotalDamagesFuserMedian_eq extends
		AttributeValueFuser<Double, Earthquake, Attribute> {

	public TotalDamagesFuserMedian_eq() {
